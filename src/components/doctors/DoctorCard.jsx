    ...
    <article className="group rounded-2xl border border-gray-100 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        <button
          ...
          className={`inline-flex items-center justify-center rounded-lg px-3 py-2 text-xs font-semibold shadow-sm transition focus:outline-none focus:ring-2 focus:ring-offset-1 ${
            isActive
              ? "border border-rose-200 bg-rose-50 text-rose-800 hover:bg-rose-100 focus:ring-rose-200"
              : "border border-emerald-200 bg-emerald-50 text-emerald-800 hover:bg-emerald-100 focus:ring-emerald-200"
          }`}
        >
          {toggleLabel}
        </button>
